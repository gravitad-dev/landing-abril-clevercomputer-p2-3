  ...
  return (
    <footer className="">
      <div className="mx-auto px-4 sm:px-1">
        {/* Top area: Blocks */}
        <div className="grid  lg:grid-cols-7 gap-8 py-8 md:py-12 border-t border-gray-200/20 px-8 lg:px-0 ">
          {/* 1st block */}
          <div
            className="sm:col-span-2 md:col-span-3 lg:col-span-3 text-start lg:ml-20"
          ...
          >
            ...
            <div className="text-white mt-10">
              <ul className="text-sm">
                <li className="mb-3 text-center md:text-left">
